    ...
    if request.method == 'POST':
        ...
        if emails:
            send_mail(
                ...
                f'Urgent need for {req.blood_group} blood. Please contact hospital.',
                'srms1161@gmail.com',
                emails,
                fail_silently=False
            )
        ...
        req.save()
        messages.success(request, "✅ Email sent! Donor search locked for 30 minutes.")
        ...
        if stock and stock.quantity > 0:
            ...
            if emails:
                send_mail(
                    ...
                    message=f"Dear Donor, urgently needed {req.blood_group} blood. Please contact hospital.",
                    from_email='admin@bloodbank.com',
